...
This document defines the recommended multi-agent workflow for UI work in Recetas.
...
Use the following prompt as the top-level coordinator for UI work in Recetas.
